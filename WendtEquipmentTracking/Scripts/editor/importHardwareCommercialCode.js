...
$(function () {
    ...
    var ImportHardwareCommercialCode = function () {

        this.hardwareCommercialCodeTable;
        this.dropzone;
                ...
                success: function (file, response) {
                    if (!response.Error) {
                        ...
                        if ($this.hardwareCommercialCodeTable) {
                            ...
                            $("#hardwareCommercialCodeRows").show();
                        }
    ...
    importHardwareCommercialCode = new ImportHardwareCommercialCode();

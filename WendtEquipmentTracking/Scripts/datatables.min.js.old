 ...
 *   https://datatables.net/download/#bs/moment-2.13.0/ed-mask-1.13.4/dt-1.10.13/af-2.1.3/e-1.6.1/ef-mask-1.5.6/fh-3.1.2/kt-2.2.0/r-2.1.1/sc-1.4.2
 *
 * Included libraries:
 *   Moment 2.13.0, jQuery Mask 1.13.4, DataTables 1.10.13, AutoFill 2.1.3, Editor 1.6.1, Field type - Mask 1.5.6, FixedHeader 3.1.2, KeyTable 2.2.0, Responsive 2.1.1, Scroller 1.4.2
 */
...
aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};m.ext=x={buttons:{},classes:{},build:"bs/moment-2.13.0/ed-mask-1.13.4/dt-1.10.13/af-2.1.3/e-1.6.1/ef-mask-1.5.6/fh-3.1.2/kt-2.2.0/r-2.1.1/sc-1.4.2",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:m.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:m.version};h.extend(x,{afnFiltering:x.search,aTypes:x.type.detect,ofnSearch:x.type.search,oSort:x.type.order,afnSortData:x.order,aoFeatures:x.feature,
...
c.extend({placeholder:a.placeholder||a.mask.replace(/[09#AS]/g,"_")},a.maskOptions));return a._input[0]},get:function(a){return a._input.cleanVal()},set:function(a,b){a._input.val(b).trigger("change").trigger("keyup.mask")},enable:function(a){a._input.prop("disabled",false)},disable:function(a){a._input.prop("disabled",true)}}});
